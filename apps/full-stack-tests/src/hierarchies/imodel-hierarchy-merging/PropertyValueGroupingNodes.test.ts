  ...
  describe("Merging iModel hierarchies", () => {
    describe("Property value grouping nodes", () => {
      describe("General case", () => {
        async function setupDbs(testName: string) {
          return createChangedDbs({
            ...
            setupChangeset1: async (builder, base) => {
              ...
              const q1 = builder.insertInstance(qSchema.items.Q.fullName, { ["Label"]: "q1", ["PropY"]: undefined });
              ...
              const q2 = builder.insertInstance(qSchema.items.Q.fullName, { ["Label"]: "q2", ["PropY"]: 123 });
        ...
        test.beforeAll(async function (_context, suite) {
