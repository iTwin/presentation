...
import type { ElementId } from "../../shared/Types.js";
import type { ParentElementsPath } from "../../shared/Utils.js";
...
export namespace CategoriesTreeNodeInternal {
  ...
  export const isModelNode = (
    node: Pick<HierarchyNode, "extendedData">,
  ): node is NonGroupingHierarchyNode & { key: InstancesNodeKey } => CategoriesTreeNode.isModelNode(node);
