...
Reusable, UI-independent tree definitions backed by iModel data and built on `@itwin/presentation-hierarchies`. The package provides models and categories trees for use in custom tree components and other hierarchy-driven workflows.
