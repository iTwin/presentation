...
import { createClassGroupingOperator, LOGGING_NAMESPACE } from "../../../../hierarchy-builder/internal/operators/grouping/ClassGrouping";
  ...
  it("groups one instance node", async () => {
    const nodes = [
      createTestNode({
        ...
        params: { grouping: { groupByClass: true } },
      }),
    ];
