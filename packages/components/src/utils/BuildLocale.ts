...
import { LOCALIZATION_NAMESPACE, LOCALIZED_STRINGS } from "../presentation-components/common/LocalizedStrings.js";
...
// clear output directory so stale (previous version) locale files are removed
...
// if locale file exists before running the script and has changes after the script is run, it means
// that LOCALIZED_STRINGS were modified and the version should be bumped
