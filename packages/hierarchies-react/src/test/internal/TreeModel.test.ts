...
describe("TreeModel", () => {
  describe("expandNode", () => {
    ...
    it("returns `reloadChildren` and removes child `Unknown` info node when expanding node", () => {
      const model = createTreeModel([
        { id: undefined, children: ["root-1", "root-2"] },
        { id: "root-1", isExpanded: false, children: ["info-1"] },
  ...
  describe("selectNodes", () => {
    ...
    it("replaces selected nodes", () => {
      const model = createTreeModel([
        ...
        { id: "root-4", type: "Unknown", message: "info" },
      ]);
...
describe("isTreeModelHierarchyNode", () => {
  it("returns correct result", () => {
    ...
    expect(isTreeModelHierarchyNode({ id: "info-node", parentId: undefined, type: "Unknown", message: "info" })).toBe(
      false,
    );
    expect(
      isTreeModelHierarchyNode({
