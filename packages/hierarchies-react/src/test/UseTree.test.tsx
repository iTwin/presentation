...
//   PresentationNoFilterMatchesError,
...
//     await waitFor(() => {
//       expect(result.current.rootNodes).to.have.lengthOf(1);
//       expect(result.current.rootNodes![0].children).to.be.true;
//     });
...
//     await waitFor(() => {
//       expect(result.current.rootNodes).to.have.lengthOf(1);
//       expect(result.current.rootNodes![0].children).to.have.lengthOf(1);
//     });
//   });
...
//     await waitFor(() => {
//       expect(result.current.rootNodes).to.have.lengthOf(1);
//       expect(result.current.rootNodes![0].children).to.have.lengthOf(2);
//     });
...
//     await waitFor(() => {
//       expect(result.current.rootNodes).to.have.lengthOf(1);
//       expect((result.current.rootNodes![0] as PresentationNoFilterMatchesError).type).to.eq("NoFilterMatches");
//     });
//   });
...
//       expect(result.current.rootNodes).to.have.lengthOf(1);
//       expect(result.current.rootNodes![0].children).to.have.lengthOf(1);
//       const childNode = (result.current.rootNodes![0].children as PresentationTreeNode[])[0] as PresentationGenericInfoNode;
...
//       expect(result.current.rootNodes).to.have.lengthOf(1);
//       expect(result.current.rootNodes![0].children).to.have.lengthOf(2);
//       const children = result.current.rootNodes![0].children as PresentationTreeNode[];
