...
export function setupModelsTree(props: {
  ...
  return {
    ...
    createInstanceKeyPaths:
      (instanceKeyPathsProps: OmitOverUnion<Props<typeof ModelsTreeDefinition.createInstanceKeyPaths>, "imodelAccess" | "idsCache" | "hierarchyConfig" | "componentId">) =>
        ModelsTreeDefinition.createInstanceKeyPaths({ ...instanceKeyPathsProps, imodelAccess: props.imodelAccess, idsCache, hierarchyConfig }),
    createSearchTree:
      async (instanceKeyPathsProps: OmitOverUnion<Props<typeof ModelsTreeDefinition.createSearchTree>, "imodelAccess" | "idsCache" | "hierarchyConfig" | "componentId">) =>
        ModelsTreeDefinition.createSearchTree({ ...instanceKeyPathsProps, imodelAccess: props.imodelAccess, idsCache, hierarchyConfig }),
  };
}
